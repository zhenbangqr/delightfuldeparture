...
function displayPaymentSummary() {
    ...
    function updateSummary() {
        ...
        if (!selectedItems || selectedItems.length === 0) {
            ...
            setTimeout(() => {
                window.location.href = "/delightfuldeparture/html/simon/homepage.html"; // Replace with your actual homepage URL
            }, 5000);
        } else {
...
function redirectToThankYouPage() {
    window.location.href = "/delightfuldeparture/html/zhenbang/thankyou.html"; // Replace with the URL of your thank you page
}
